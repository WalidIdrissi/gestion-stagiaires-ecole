...
<body>
    ...
    <div style="margin: 25px">
        <h2>Tous les stagiaires {{ App\Models\Stagiaire::count() }}</h2>
        <br>
        <div class="div-table">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $value->ville }}</td>
                        <td>{{ $value->email }}</td>
                        <td><img src="{{ asset($value->photo) }}" alt="Photo de stagiaire" width="50px"></td>
                        <td>{{ $value->groupe->groupe }}</td>
                        <td>{{ $value->groupe->filiere->filiere }}</td>
                        <td>
                            <span>
